...
class UK_Dale_Parser:
    ...
    def load_data(self, house_indicies):
        ...
        #    assert appliance in ['kettle', 'microwave', 'fridge', 'washing machine', 'dish washer']
        ...
        for house_id in house_indicies:
            ...
            house_data = house_data[['active','kettle', 'microwave', 'fridge', 'washing machine', 'dish washer']]
