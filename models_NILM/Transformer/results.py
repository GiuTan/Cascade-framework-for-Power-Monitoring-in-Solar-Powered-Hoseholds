...
experiment_name = 'NILM'

data = 'UKDALE'

appliance_names = ['kettle', 'microwave', 'fridge', 'washing machine', 'dish washer']
...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        per_app_results_csv = os.path.join(path_csv, 'per_app_results.csv')
    ...
    df_per_app_results.to_csv('./experiment_'+ experiment_name +str(window_stride)+'_per_app_results.csv', index=False)
