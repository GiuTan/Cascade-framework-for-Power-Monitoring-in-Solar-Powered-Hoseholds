...
from net.model import TransUNetNILM
...
if __name__ == '__main__':
    ...
    ##### Model #####
    model = TransUNetNILM(in_size=args.in_size, seq_len=args.seq_len, out_size=args.out_size, pred_len=args.pred_len, dropout=args.dropout, n_layers_unet=args.n_layers_unet, n_layers_transformer=args.n_layers_transformer, n_heads=args.n_heads, features_start=args.features_start, d_ff=args.d_ff)
    ...
    ##### Saving results #####
    per_app_results.to_csv(os.path.join(path_logs, '50_per_app_results.csv'), index=True)
