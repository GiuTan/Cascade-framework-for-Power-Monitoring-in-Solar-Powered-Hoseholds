...
def get_args():
    ...
    parser.add_argument('--model_name', default='TCN', type=str)
    ...
    parser.add_argument('--out_size', default=7, type=int)
    ...
    parser.add_argument('--appliance_names', default=['active', 'solar', 'kettle', 'microwave', 'fridge', 'washing machine', 'dish washer'], nargs='+', type=str)

    parser.add_argument('--seq_len', type=int, default=480)
    parser.add_argument('--pred_len', type=int, default=480)
    parser.add_argument('--window_stride', type=int, default=240)
    parser.add_argument('--validation_size', type=float, default=0.2)

    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--seed', default=9, type=int, help='Seed for the reproducibility of the experiment')
