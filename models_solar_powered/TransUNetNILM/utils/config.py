...
def get_args():
    ...
    parser.add_argument('--model_name', default='TransUNetNILM', type=str)
    ...
    parser.add_argument('--n_layers_unet', type=int, default=3)
    parser.add_argument('--n_layers_transformer', type=int, default=4)
