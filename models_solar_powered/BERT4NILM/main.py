...
from net.model import BERT4NILM
...
if __name__ == '__main__':
    ...
    ##### Model #####
    model = BERT4NILM(in_size=args.in_size, seq_len=args.seq_len, out_size=args.out_size, pred_len=args.pred_len, dropout=args.dropout, hidden_size=args.hidden_size, n_heads=args.n_heads, n_layers=args.n_layers, d_ff=args.d_ff)
